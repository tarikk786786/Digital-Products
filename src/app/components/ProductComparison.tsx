        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {featuredProducts.map((product, idx) => (
            ...
            >
              ...
              {product.type === "bundle" && product.price === 999 && (
                <div className="absolute inset-0 bg-gradient-to-b from-[#d4af37]/5 to-transparent pointer-events-none rounded-[1.4rem]"></div>
              )}
              ...
              <div className="rounded-[1.4rem] bg-[#111115] overflow-hidden flex-grow flex flex-col relative z-10 m-[1px]">
                <div className="h-56 overflow-hidden relative">
                  <div className="absolute inset-0 bg-gradient-to-t from-[#111115] to-transparent z-10 h-full w-full"></div>
                  <motion.img 
                ...
                <div className="p-8 flex-grow flex flex-col relative z-20 -mt-10">
                  ...
                  <div className="flex items-center gap-4 mb-6 text-sm text-gray-400">
                    ...
                    <span className="flex items-center gap-1"><FaUserFriends /> {product.students}</span>
                    <span className="flex items-center gap-1"><FaDownload /> {product.downloads}</span>
                  </div>
                  ...
                  <button className={`w-full py-4 rounded-xl font-bold flex justify-center items-center gap-2 transition-all ${
                    product.price === 999 
