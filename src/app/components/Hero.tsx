  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center pt-24 pb-12 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-[url('https://intimacyacademy.in/wp-content/uploads/2026/03/banner3-6c6ec6feb9977bf8c65c24d81c4cd99b.jpeg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <a href="#products" className="w-full sm:w-auto bg-gradient-to-r from-[#d4af37] to-yellow-600 hover:from-yellow-400 hover:to-yellow-500 text-black px-10 py-5 rounded-2xl font-bold text-lg shadow-[0_0_30px_rgba(212,175,55,0.4)] transition-all flex items-center justify-center gap-3 transform hover:scale-105">
              Explore Library
            </a>
            <a href="#video-intro" className="w-full sm:w-auto glass px-10 py-5 rounded-2xl font-bold text-lg text-white hover:bg-white/10 transition-all flex items-center justify-center gap-3">
          ...
          >
            <div className="flex items-center gap-2">
              <FaShieldAlt className="text-[#d4af37] text-xl" /> Secure Checkout
            </div>
            <div className="flex items-center gap-2">
              <FaMobileAlt className="text-[#d4af37] text-xl" /> Mobile Friendly
            </div>
            <div className="flex items-center gap-2">
              <FaLock className="text-[#d4af37] text-xl" /> Private Access
            </div>
          </motion.div>
        </div>
      </div>
